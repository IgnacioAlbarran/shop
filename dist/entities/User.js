...
var User = exports.User = (_dec = Entity(), _dec2 = PrimaryGeneratedColumn(), _dec3 = Column('varchar'), _dec4 = Column('varchar'), _dec5 = Index({ unique: true }), _dec6 = Column('varchar'), _dec7 = Column('varchar'), _dec8 = Column({ type: 'integer', default: 1 }), _dec9 = OneToMany(function () {
  return _Order.Order;
}, function (order) {
  return order.user;
}), _dec10 = JoinColumn(), _dec11 = DeleteDateColumn(), _dec(_class = (_class2 = function User() {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'orders', [_dec9, _dec10], {
  enumerable: true,
  initializer: function initializer() {
    return _Order.Order;
  }
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'deletedAt', [_dec11], {
  enumerable: true,
  initializer: function initializer() {
    return undefined;
  }
